...
namespace Sales_DAL
{
    public class Dlayer
    {
        ...
        //string constr = @"Data Source= 203.124.43.65;Initial Catalog=mechatronix;User Id = mechatronix; Password = OranG3!#123";
        string constr = @"Data Source= 50.97.97.155,1982;Initial Catalog=Mechatronix;User Id = mecha_mechatronix; Password = Mechatronix@123";
