<%@ Page Language="C#" MasterPageFile="~/MCTX_Internal/SuperAdmin/MasterAdmin.master"
    AutoEventWireup="true" CodeFile="frmProspectingList.aspx.cs" Inherits="MCTX_Internal_SuperAdmin_frmProspectingList"
    Title="Prospecting List" EnableEventValidation="false" %>
                ...
                <td>
                    <fieldset style="border: 1px solid #ABD3FC">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td>
                                     <asp:TextBox Visible="false" ID="txtPropectID" runat="server" />
                                </td>
                                <td>
                                </td>
                                <td>
                                    ...
                                    <table align="center" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; padding-left: 50px;">
                                                ...
                                                <asp:Button ID="btnExportToExcel" Width="98px" runat="server" BackColor="#ABD3FC"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetProspects() {
            ...
            $.ajax({
                ...
                url: "frmProspectingList.aspx/GetProspects",
        ...
        function OnSuccessProspects(msg) {
            ...
            dyn_table += "<th id='txtDeleteth' style='cursor:Pointer;text-align:center;white-space:nowrap;border:1px solid #999999;'>Delete</th>";
            dyn_table += "<th id='txtEditth' style='cursor:Pointer;text-align:center;white-space:nowrap;border:1px solid #999999;display:none;'>Edit</th>";
            dyn_table += "<th style='white-space:nowrap; text-align:left; display:none;'>Prospect ID</th>";
            ...
            for (var i = 0; i < data.Prospects.length; i++) {
                ...
                dyn_table += "<td id='txtDelete" + i + "' align='center' style='border:1px solid #999999;'> <input  type='image' src='image/Cross.png' style='width:16px; border:0px;' onclick='return DeleteProspect(" + i + ");'></td>";
                dyn_table += "<td id='txtEdit" + i + "' align='center' style='border:1px solid #999999;display:none'> <input  type='image' src='image/Edit.png' style='width:16px; border:0px;' onclick='return GetRowForUpdation(" + i + ");'></td>";
                dyn_table += "<td style='text-align:right; white-space:nowrap; display:none;' id='txtProspectID" + i + "'>" + data.Prospects[i].Prospecting_id + "</td>";
        ...
        function OnChange_Country_Company() {
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/LoadCity_Company",
        ...
        function OnChange_Country_Client() {
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/LoadCity_Client",
                data: "{'countryid':'" + CountryId + "'}",
        ...
        function OnChange_CompanyList_Prospecting() {
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/LoadClients_Prospecting",
        ...
        function Add_Prospecting() {
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/Add_Prospecting",
                async: false,
        ...
        function Add_ClientInfo() {
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/Add_ClientInfo",
                async: false,
        ...
        function SaveCompInfo() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/SaveCompanyInfo",
                async: false,
        ...
        function Load_Companies() {
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/Load_Companies",
                data: "{}",
        ...
        function OnErrorLoad_Companies(msg) {
       alert(msg.responseText);
        ...
        function Load_CategoriesDDL() {
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/Load_CategoriesDDL",
                data: "",
        ...
        function GetCategory_Products_DDL() {
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                url: "frmProspectingList.aspx/GetCategory_Products_DDL",
                data: "{'Cat_Id':" + Cat_id + "}",
        ...
        function DeleteProspect(rowNo) {
          
            if ($("#lblUserName").text().trim() != $("#txtE_Name" + rowNo).html().trim())
            {
                alert("You can not delete this Record!");
               
                return false;
            }
            var ProspectID = $("#txtProspectID" + rowNo).html().trim();
            if (confirm("Are you sure you wish to delete this Record?")) {
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    url: "frmProspectingList.aspx/DeleteProspect",
                    data: "{'ProspectID':'" + ProspectID + "'}",
                    success: onSuccessDeleteProspect,
                    error: OnDeleteErrorDeleteProspect
                });
                return false;
            }
            return false;
        }
        function onSuccessDeleteProspect() {
            alert("Record Successfully Deleted!");
            GetProspects();
            return false;
        }

        function OnDeleteErrorDeleteProspect() {
