<%@ Page Language="C#" MasterPageFile="~/MCTX_Internal/SuperAdmin/MasterAdmin.master"
    AutoEventWireup="true" CodeFile="frmDailyOutputReport_mubashirbhai.aspx.cs" Inherits="MCTX_Internal_SuperAdmin_frmDailyOutputReport"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="tabs" style="width: auto;">
        ...
        <table style="width: 99%" class="dataTable">
            <tr>
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="lblOfficeTimeIn" Text="My Today's Check-In:" runat="server"></asp:Label>&nbsp;
                    <asp:DropDownList ID="ddlCInHrs" AutoPostBack="true" onChange="return timein();"
                        runat="server">
        ...
        <table id="tblDailyReport" class="dataTable" style="width: 99%; background-color: White;">
            <tr>
            ...
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime1" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime1" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime1" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj1" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <span style="padding-left: 528px">MIN</span>
                    <table width="100%">
                        <tbody>
                            <tr>
                                <td width="1%">
                                ...
                                <td>
                                    <asp:TextBox ID="TextBox1" Style="width: 100%; " runat="server"></asp:TextBox>
                                </td>
                                <td width="7%">
                                <asp:TextBox ID="TextBox4" Style="width: 100%;" MaxLength="2" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                  <asp:TextBox ID="TextBox2" Style="width: 100%;" runat="server"></asp:TextBox>
                                </td>
                                <td>
                                <asp:TextBox ID="TextBox5" Style="width: 100%;" MaxLength="2" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                   <asp:TextBox ID="TextBox3" Style="width: 100%;" runat="server"></asp:TextBox>
                                </td>
                                <td>
                                <asp:TextBox ID="TextBox6" Style="width: 100%;" MaxLength="2" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <asp:TextBox ID="txtOutput1" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave1" Text="Save" Style="width: 100%;" OnClientClick="return saveHr1();"
            ...
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime2" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime2" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime2" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj2" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput2" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave2" Text="Save" Style="width: 100%;" OnClientClick="return saveHr2();"
                        runat="server"></asp:Button>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime3" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime3" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime3" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj3" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput3" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave3" Text="Save" Style="width: 100%;" OnClientClick="return saveHr3();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime4" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime4" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime4" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj4" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput4" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave4" Text="Save" Style="width: 100%;" OnClientClick="return saveHr4();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime5" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime5" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime5" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj5" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput5" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave5" Text="Save" Style="width: 100%;" OnClientClick="return saveHr5();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime6" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime6" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime6" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj6" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput6" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave6" Text="Save" Style="width: 100%;" OnClientClick="return saveHr6();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime7" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime7" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime7" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj7" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput7" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave7" Text="Save" Style="width: 100%;" OnClientClick="return saveHr7();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime8" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime8" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime8" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj8" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput8" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave8" Text="Save" Style="width: 100%;" OnClientClick="return saveHr8();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime9" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime9" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime9" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj9" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput9" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave9" Text="Save" Style="width: 100%;" OnClientClick="return saveHr9();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime10" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime10" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime10" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj10" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput10" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave10" Text="Save" Style="width: 100%;" OnClientClick="return saveHr10();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime11" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime11" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime11" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj11" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput11" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave11" Text="Save" Style="width: 100%;" OnClientClick="return saveHr11();"
                        runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtFrmTime12" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtToTime12" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 10%; text-align: left;">
                    <asp:TextBox ID="txtRPTTime12" Style="width: 100%;" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 15%; text-align: left;">
                    <asp:DropDownList ID="ddlProj12" AutoPostBack="false" Style="width: 99%; font-family: Calibri;"
                        runat="server">
                    </asp:DropDownList>
                </td>
                <td style="width: 45%; text-align: left;">
                    <asp:TextBox ID="txtOutput12" Style="width: 100%; height: 20px;" runat="server"></asp:TextBox>
                </td>
                <td style="width: 5%; text-align: center;">
                    <asp:Button ID="btnSave12" Text="Save" Style="width: 100%;" OnClientClick="return saveHr12();"
                        runat="server" />
                </td>
            </tr>
        </table>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="width: 75%; text-align: left;">
                    <asp:TextBox ID="txtfatigues" Width="85%" Height="75px" TextMode="MultiLine" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 25%; font-family: Calibri; color: DarkBlue; text-align: left;">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="font-family: Calibri; color: DarkBlue; text-align: left; width: 80%;">
                    <asp:DropDownList ID="ddlCOutHrs" Style="font-family: Calibri; width: 100px; color: DarkBlue;"
                        runat="server">
                        <asp:ListItem>Hrs</asp:ListItem>
                        <asp:ListItem>00</asp:ListItem>
                        <asp:ListItem>01</asp:ListItem>
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Button ID="btnSubmit" Text="Send Final Report" Style="width: 120px; height: 30px;
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            userDept();
            ProjOption();
            // var idleInterval = setInterval("reloadPage()", 300000);
        });
        var DeptID = "";
        function reloadPage() {
        ...
        function reportTime() {
            ...
            var OutPut1 = $("input[id$='txtOutput1']").val();
            if (OutPut1 == "") //$("input[id$='txtOutput1']").val();
            {
                $("input[id$='txtRPTTime1']").val(RPTTime);
            }
            var OutPut2 = $("input[id$='txtOutput2']").val();
            if (OutPut2 == "") {
                $("input[id$='RPTTime2']").val(RPTTime);
            }
            var OutPut3 = $("input[id$='txtOutput3']").val();
            if (OutPut3 == "") {
                $("input[id$='txtRPTTime3']").val(RPTTime);
            }
            var OutPut4 = $("input[id$='txtOutput4']").val();
            if (OutPut4 == "") {
                $("input[id$='txtRPTTime4']").val(RPTTime);
            }
            var OutPut5 = $("input[id$='txtOutput5']").val();
            if (OutPut5 == "") {
                $("input[id$='txtRPTTime5']").val(RPTTime);
            }
            var OutPut6 = $("input[id$='txtOutput6']").val();
            if (OutPut6 == "") {
                $("input[id$='txtRPTTime6']").val(RPTTime);
            }
            var OutPut7 = $("input[id$='txtOutput7']").val();
            if (OutPut7 == "") {
                $("input[id$='txtRPTTime7']").val(RPTTime);
            }
            var OutPut8 = $("input[id$='txtOutput8']").val();
            if (OutPut8 == "") {
                $("input[id$='txtRPTTime8']").val(RPTTime);
            }
            var OutPut9 = $("input[id$='txtOutput9']").val();
            if (OutPut9 == "") {
                $("input[id$='txtRPTTime9']").val(RPTTime);
            }
            var OutPut10 = $("input[id$='txtOutput10']").val();
            if (OutPut10 == "") {
                $("input[id$='txtRPTTime10']").val(RPTTime);
            }
            var OutPut11 = $("input[id$='txtOutput11']").val();
            if (OutPut11 == "") {
                $("input[id$='txtRPTTime11']").val(RPTTime);
            }
            var OutPut12 = $("input[id$='txtOutput12']").val();
            if (OutPut12 == "") {
        ...
        function saveHr1() {
            ...
            if (Hrs > (parseInt(toTime1[0]) + 1)) {
                alert("Report Time For this Hour is expired!");
                return false;
            }

            if (Hrs == (parseInt(toTime1[0]) + 1)) {
                if (Mins > parseInt(toTime1[1])) {
                    alert("Report Time For this Hour is expired!");
                    return false;
                }
            }
            ...
            $.ajax({
                ...
                data: "{'EmpName':'" + EmpName + "','TimeIn':'" + TimeIn + "','FrmTime1':'" + FrmTime1 + "','ToTime1':'" + ToTime1 + "','RPTTime1':'" + RPTTime1 + "','Proj1':'" + Proj1 + "','Task1':'" + Task1 + "','Hr1':'" + Hr1 + "','DailyReport_ID':'" + DailyReport_ID + "'}",
        ...
        function onsuccessSave(msg) {
            ...
            var data = msg.d;
            if (data.toString() == "expired") {
                alert("Report Time For this Hour is expired!");
                return false;
            }

            $("span[id$='lblReportID']").text(data);
            var ua = $.browser;
            if (ua.msie) {
        ...
        function saveHr8() {
            ...
            // Added by Khalid to restrict to add previous hours report
            if (Hrs > (parseInt(toTime8[0]) + 1)) {
                alert("Report Time For this Hour is expired!");
                return false;
            }

            if (Hrs == (parseInt(toTime8[0]) + 1)) {
                if (Mins > parseInt(toTime8[1])) {
                    alert("Report Time For this Hour is expired!");
                    return false;
                }
            }
        ...
        function saveHr9() {
            ...
            // Added by Khalid to restrict to add previous hours report
            if (Hrs > (parseInt(toTime9[0]) + 1)) {
                alert("Report Time For this Hour is expired!");
                return false;
            }

            if (Hrs == (parseInt(toTime9[0]) + 1)) {
                if (Mins > parseInt(toTime9[1])) {
                    alert("Report Time For this Hour is expired!");
                    return false;
                }
            }
        ...
        function saveHr10() {
            ...
            // Added by Khalid to restrict to add previous hours report
            if (Hrs > (parseInt(toTime10[0]) + 1)) {
                alert("Report Time For this Hour is expired!");
                return false;
            }

            if (Hrs == (parseInt(toTime10[0]) + 1)) {
                if (Mins > parseInt(toTime10[1])) {
                    alert("Report Time For this Hour is expired!");
                    return false;
                }
            }
        ...
        function saveHr11() {
            ...
            // Added by Khalid to restrict to add previous hours report
            if (Hrs > (parseInt(toTime11[0]) + 1)) {
                alert("Report Time For this Hour is expired!");
                return false;
            }

            if (Hrs == (parseInt(toTime11[0]) + 1)) {
                if (Mins > parseInt(toTime11[1])) {
                    alert("Report Time For this Hour is expired!");
                    return false;
                }
            }
        ...
        function saveHr12() {
            ...
            // Added by Khalid to restrict to add previous hours report
            if (Hrs > (parseInt(toTime12[0]) + 1)) {
                alert("Report Time For this Hour is expired!");
                return false;
            }

            if (Hrs == (parseInt(toTime12[0]) + 1)) {
                if (Mins > parseInt(toTime12[1])) {
                    alert("Report Time For this Hour is expired!");
                    return false;
                }
            }
        ...
        function finalReport() {
            ...
            var Fatigues = "";
            Fatigues = $("textarea[id$='txtfatigues']").val();
            ...
            $.ajax({
                ...
                data: "{'CheckOut':'" + CheckOut + "','Output':'" + Output + "','ContSenior':'" + ContSenior + "','DailyReport_ID':'" + DailyReport_ID + "','Fatigues':'" + Fatigues + "'}",
        ...
        function SendEmail() {
            ...
            var Fatigues = $("textarea[id$='txtfatigues']").val();
