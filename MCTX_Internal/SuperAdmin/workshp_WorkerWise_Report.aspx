<%@ Page Title="Worker Wise Report" Language="C#" MasterPageFile="~/MCTX_Internal/SuperAdmin/MasterAdmin.master" AutoEventWireup="true" CodeFile="workshp_WorkerWise_Report.aspx.cs" Inherits="MCTX_Internal_SuperAdmin_workshp_WorkerWise_Report" %>
...
.highlight { background-color: red; }
     ...
     <div id="tabs" style="width: 95%;">
        <ul>
            <li style="text-align: left"><a href="#tabs-1">Worker Wise Report</a></li>
        </ul>
      
        <fieldset id="fldOutPutChart" style="width:94%; padding:2%">
            <legend>Worker Wise Report</legend>
            <table style="width: 100%; font-family: Calibri; font-size: 11pt;">
                <tr>
                    <td >
                            ...
                            <rjs:PopCalendar ID="rjsDOB" Separator="/" Format="mm dd yyyy" Control="txtDateFrom" runat="server"
                                Font-Names="Tahoma" />
                                    </td>
                                    <td>
                                        Date To:
                            ...
                            <rjs:PopCalendar ID="PopCalendar1" Separator="/" Format="mm dd yyyy" Control="txtDateTo" runat="server"
                                Font-Names="Tahoma" />
                                    ...
                                    <tr> 
                                    <td align="right" style="text-align:right;padding-right:12.6%"  colspan="4">
                                         
                                        <asp:Button ID="btnSearchWorkerWiseReport" Text="Search" Style="background-color: #2A4062;
                                            color: White; width: 84px" OnClientClick="return getWorkerWiseReport();" runat="server" />
        ...
        <fieldset style="width: 94%;padding:2%;padding-top: 0%;">
            <legend style="text-align: left;">Worker Wise Report</legend>
            ...
            <div id="Div1" style="overflow: auto; width: 1160px; height: 300px;" runat="server">
                <table id="tblWorkerWiseReport" class="dataTable">
                </table>
            </div>
        </fieldset>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnExport").click(function (e) {
                ...
                tab = document.getElementById('tblWorkerWiseReport'); // id of table
        ...
        function dataTable() {
            oTable = $("#tblWorkerWiseReport").dataTable({
                bPaginate: true,
               // bJQueryUI: true,
                bSort: true,
                bInfo: true,
            ...
            $("#tblWorkerWiseReport_length").css("text-align", "left");
            $("#tblWorkerWiseReport_filter").css("text-align", "left");
        }
        ...
        function getWorkerWiseReport() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "workshp_WorkerWise_Report.aspx/getWorkerWiseReport",
                data: "{'empid':'" + empid + "','projectid':'" + projectid + "','fromDate':'" + fromDate + "','toDate':'" + toDate + "'}",
                success: onsuccessgetWorkerWiseReport,
                error: onretrievegetWorkerWiseReport
            });
            return false;
        }
        function onsuccessgetWorkerWiseReport(msg) {
            ...
            tbl += "</tbody>";
            tbl += "</table>";
            $("#tblWorkerWiseReport").html(tbl);
            //dataTable();
            return false;
        }
        function onretrievegetWorkerWiseReport() {
            alert("Error In Loading Details!");
            return false;
        }
        ...
        function EditOutPutRecord(rowNo) {
            ...
            $("input[id$='btnSearchWorkerWiseReport']").attr("disabled", true);
            return false;
        }
