<%@ Page Title="" Language="C#" MasterPageFile="~/MCTX_Internal/SuperAdmin/MasterAdmin.master" AutoEventWireup="true" CodeFile="CostingIndexCategory.aspx.cs" Inherits="MCTX_Internal_SuperAdmin_CostingIndexCategory_" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left" >
                                        ...
                                        <asp:Button ID="btnAddCategory" Text="Add Category" Style="background-color: #2A4062;
                                            color: White; width: 84px" OnClientClick="return AddCategoryItem();" runat="server" OnClick="btnAddCategory_Click" />
