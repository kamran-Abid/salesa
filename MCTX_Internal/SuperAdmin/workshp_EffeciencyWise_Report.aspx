<%@ Page Title="Project Wise Report" Language="C#" MasterPageFile="~/MCTX_Internal/SuperAdmin/MasterAdmin.master" AutoEventWireup="true" CodeFile="workshp_EffeciencyWise_Report.aspx.cs" Inherits="MCTX_Internal_SuperAdmin_workshp_EffeciencyWise_Report" %>
...
.highlight { background-color: red; }
     ...
     <div id="tabs" style="width: 95%;">
            ...
            <table style="width: 100%; font-family: Calibri; font-size: 11pt;">
                <tr>
                    <td >
                            ...
                            <asp:Label ID="Label2" Text="Select Grade:" runat="server"></asp:Label>
                        </td>
                                    <td style="width: 300px;">
                                       <asp:DropDownList ID="ddlActivityGradeId"  runat="server" >
                                         </asp:DropDownList>
                                    </td>
                                    <td >
                                         
                                        <asp:Button ID="btnSearchEffecienyReport" Text="Search" Style="background-color: #2A4062;
                                            color: White; width: 84px" OnClientClick="return getEffecienyReport();" runat="server" />
        ...
        <fieldset style="width: 94%;padding:2%;padding-top: 0%;">
            <legend style="text-align: left;">Effeciency Wise Report</legend>
            ...
            <div id="Div1" style="overflow: auto; width: 1160px; height: 300px;" runat="server">
                <table id="tblEffeciencyWiseReport" class="dataTable">
                </table>
            </div>
        </fieldset>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnExport").click(function (e) {
                ...
                tab = document.getElementById('tblEffeciencyWiseReport'); // id of table
        ...
        function dataTable() {
            oTable = $("#tblEffeciencyWiseReport").dataTable({
                bPaginate: true,
               // bJQueryUI: true,
                bSort: true,
                bInfo: true,
            ...
            $("#tblEffeciencyWiseReport_length").css("text-align", "left");
            $("#tblEffeciencyWiseReport_filter").css("text-align", "left");
        }
        ...
        function getProgetPriority() {
            ...
            var EffeciencyID = $("select[id$='ddlActivityGradeId']").val();
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "workshp_outputChart.aspx/getPriority",
                data: "{'EffeciencyID':'" + EffeciencyID + "'}",
        ...
        function onerrorPriority() {
            alert("Error In Loading Effeciency Priority!");
            return false;
        }
        ...
        //-----------------------------------------------------Get Effeciency Wise Report-----------------------------------------------------

        function getEffecienyReport() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "workshp_EffeciencyWise_Report.aspx/getEffecienyReport",
                data: "{'Effeciencyid':'" + Effeciencyid + "'}",
                success: onsuccessgetEffecienyReport,
                error: onretrievegetEffecienyReport
            });
            return false;
        }
        function onsuccessgetEffecienyReport(msg) {
            ...
            tbl += "</tbody>";
            tbl += "</table>";
            $("#tblEffeciencyWiseReport").html(tbl);
            //dataTable();
            return false;
        }
        function onretrievegetEffecienyReport() {
            alert("Error In Loading Details!");
            return false;
        }
        ...
        function EditOutPutRecord(rowNo) {
            ...
            $("select[id$='ddlActivityGradeId']").val(txtProject_ID);
            ...
            $("input[id$='btnSearchEffecienyReport']").attr("disabled", true);
            return false;
        }
        ...
        function updateOutputChart() {
           ...
           var outputChartID= $("input[id$='txtOuputChartID']").val();
            ...
            var projectid = $("select[id$='ddlActivityGradeId']").val();
